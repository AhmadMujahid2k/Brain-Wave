  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full z-50 
		...
		lg:backdrop-blur-sm ${
      openNaviagtion ? "bg-n-8 " : "bg-n-8/90 backdrop-blur-sm"
    }`}
    >
      <div
      ...
      >
        ...
        >
          <div
            className="realtive z-2 flex flex-col
            ...
            {navigation.map((item) => (
              <a
                ...
                className={`block relative font-code text-2xl uppercase text-n-1 
					...
					${item.onlyMobile ? "lg:hidden" : ""} px-6 py-6 md:py-8 lg:-mr-0.5
